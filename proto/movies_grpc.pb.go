...
const (
	...
	MovieService_GetMovieStatus_FullMethodName = "/movies.MovieService/GetMovieStatus"
)
...
type MovieServiceClient interface {
	...
	GetMovieStatus(ctx context.Context, in *GetMovieStatusRequest, opts ...grpc.CallOption) (*GetMovieStatusResponse, error)
}
...
func (c *movieServiceClient) GetMovieStatus(ctx context.Context, in *GetMovieStatusRequest, opts ...grpc.CallOption) (*GetMovieStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMovieStatusResponse)
	err := c.cc.Invoke(ctx, MovieService_GetMovieStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServiceServer interface {
	...
	GetMovieStatus(context.Context, *GetMovieStatusRequest) (*GetMovieStatusResponse, error)
...
func (UnimplementedMovieServiceServer) GetMovieStatus(context.Context, *GetMovieStatusRequest) (*GetMovieStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMovieStatus not implemented")
}
...
func _MovieService_GetMovieStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMovieStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).GetMovieStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetMovieStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).GetMovieStatus(ctx, req.(*GetMovieStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MovieService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMovieStatus",
			Handler:    _MovieService_GetMovieStatus_Handler,
		},
	},
